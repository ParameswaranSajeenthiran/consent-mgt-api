...
//    // Suppression reason -
//    //      WEAK_FILENAMEUTILS - False positive: The vulnerability is fixed from Java 7 update 40 and Java 8+
//    versions
//    //      PATH_TRAVERSAL_IN  - False positive: The user input value is only filename and it is secured using
//    //                                           FilenameUtils. This could be a true positive if directory path is
//    sent
