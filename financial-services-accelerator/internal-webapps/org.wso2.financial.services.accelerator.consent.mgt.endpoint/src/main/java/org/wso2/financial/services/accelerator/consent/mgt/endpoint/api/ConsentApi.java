...
import org.wso2.financial.services.accelerator.consent.mgt.endpoint.model.ConsentResource;
...
public class ConsentApi {
    ...
    public Response consentConsentIdDelete(
        ...
        try {
            return Response.ok().entity(consentMgtApiHandler.consentConsentIdDelete(consentId,
                    orgInfo,
                    userId)).build();
        } catch (Exception e) {
            // Handle other errors
    ...
    public Response consentConsentIdGet(
            @PathParam("consentId") @ApiParam("consent id") String consentId,
            @HeaderParam("OrgInfo") @ApiParam("jwt header containing tenant related information") String orgInfo,
            @QueryParam("detailedConsent") boolean detailedConsent,
            @QueryParam("UserId") String userId,
            @QueryParam("WithAttributes") boolean withAttributes

                                       ) {
        try {
            return Response.ok().entity(consentMgtApiHandler.consentConsentIdGet(consentId,
                    orgInfo,
                    detailedConsent,
                    userId,
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "Successful operation", response = ConsentHistory.class,
    ...
    public Response consentConsentIdHistoryGet(
        ...
        try {
            return Response.ok().entity(consentMgtApiHandler.consentConsentIdHistoryGet(consentId,
                    orgInfo,
                    detailed,
                    status,
                    actionBy,
    ...
    @ApiResponses(
            value = {@ApiResponse(code = 200, message = "Successful operation", response = AmendmentResponse.class),
    ...
    public Response consentConsentIdPut(
            ...
            @HeaderParam("OrgInfo") @ApiParam("jwt header containing tenant related information") String orgInfo) {
        try {
            return Response.ok().entity(consentMgtApiHandler.consentConsentIdPut(consentId,
                    amendmentResource,
                    orgInfo)).build();
        } catch (Exception e) {
            // Handle other errors
    ...
    public Response consentConsentIdStatusPut(
            ...
            @HeaderParam("OrgInfo") @ApiParam("jwt header containing tenant related information") String orgInfo) {
        try {
            return Response.ok().entity(consentMgtApiHandler.consentConsentIdStatusPut(consentId,
    ...
    public Response consentGet(
        ...
        try {
            return Response.ok().entity(consentMgtApiHandler.consentGet(orgInfo,
                    consentTypes,
                    consentStatuses,
                    userIds,
                    fromTime,
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "Successful operation", response = ConsentResponse.class),
            @ApiResponse(code = 400, message = "Invalid request body", response = Void.class)})
    public Response consentPost(
        ...
        try {
            return Response.ok().entity(consentMgtApiHandler.consentPost(consentResource,
                    orgInfo,
                    isImplicitAuth,
                    exclusiveConsent)).build();
        } catch (Exception e) {
            // Handle other errors
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity("An unexpected error occurred: " + e.getMessage()).build();
    ...
    public Response consentStatusPut(
            ...
            @HeaderParam("OrgInfo") @ApiParam("jwt header containing tenant related information") String orgInfo) {
        try {
            return Response.ok().entity(consentMgtApiHandler.consentStatusPut(bulkConsentStatusUpdateResource,
                    orgInfo)).build();
        } catch (Exception e) {
            // Handle other errors
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
