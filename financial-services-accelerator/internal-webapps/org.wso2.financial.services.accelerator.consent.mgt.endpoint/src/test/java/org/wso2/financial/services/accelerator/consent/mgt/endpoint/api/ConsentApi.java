...
public class ConsentApi {
    ...
    public Response consentConsentIdGet(
        ...
        try {
            return Response.ok()
                    .entity(consentAPIImpl.consentConsentIdGet(consentId, orgInfo, detailedConsent, userId,
    ...
    public Response consentConsentIdPut(
            ...
            @HeaderParam("OrgInfo") @ApiParam("jwt header containing tenant related information") String orgInfo) {
        try {
            return Response.ok().entity(consentAPIImpl.consentConsentIdPut(consentId, amendmentResource, orgInfo))
                    .build();
        } catch (ConsentManagementRuntimeException e) {
    ...
    public Response consentPost(
            ...
            @HeaderParam("OrgInfo") @ApiParam("jwt header containing tenant related information") String orgInfo,
            @QueryParam("IsImplicitAuth") @ApiParam("Flag to determine whether authorization is implicit or not")
            boolean isImplicitAuth,
            @QueryParam("ExclusiveConsent") @ApiParam("Flag to determine whether this is an exclusive consent")
